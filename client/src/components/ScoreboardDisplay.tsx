...
const TARGET_WIDTH = 1920; // Use a common HD target resolution
...
export default function ScoreboardDisplay({ config }: ScoreboardDisplayProps) {
  ...
  if (layout === "sideBySide") {
    return (
      <div className="pt-24 pl-24"> {/* Apply simple padding BEFORE scaling */}
        <CoreWrapper>
  ...
  if (layout === "stacked") {
    ...
    return (
      <div className="pt-24 pl-96"> {/* Apply large padding BEFORE scaling */}
        <CoreWrapper>
